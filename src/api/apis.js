...
export const Token = (parameters = {}) => {
  ...
  if (parameters["username"] === undefined) {
    return Promise.reject(
      new Error("Missing required String parameter: username")
    );
  }
  ...
  if (parameters["password"] === undefined) {
    return Promise.reject(
      new Error("Missing required String parameter: password")
    );
  }
  ...
  if (parameters["grant_type"] === undefined) {
    return Promise.reject(
      new Error("Missing required String parameter: grant_type")
    );
  }
...
export const TokenURL = (parameters = {}) => {
  ...
  return (
    ...
    (keys.length > 0
      ? "?" +
        keys.map((key) => key + "=" + encodeURIComponent(querys[key])).join("&")
      : "")
  );
};
...
export const ModifyUserPassword = (parameters = {}) => {
  ...
  if (parameters["old_password"] === undefined) {
    return Promise.reject(
      new Error("Missing required String parameter: old_password")
    );
  }
  ...
  if (parameters["new_password"] === undefined) {
    return Promise.reject(
      new Error("Missing required String parameter: new_password")
    );
  }
  return request("patch", url, params, config);
};
